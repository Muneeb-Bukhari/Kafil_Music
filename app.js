...
closecart.addEventListener("click",function(){
    ...
    //HMABURER ICON// 
let hamburger = document.querySelector('.iconCart-2');
...
function updatePriceAndSave(variant, price, CardNumber,cardId) {
...
function addToCartWithSelectedVariantPrice(title, imgSrc, cardNumber, variant) {
 ...
 let cart = JSON.parse(localStorage.getItem('cart')) || [];
  ...
  if (existingProductIndex !== -1) {
    ...
    alert("BEAT HAS ALREADY ADDED TO CART WITH SPECIFIED LICENSE")
